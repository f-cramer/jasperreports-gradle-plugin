...
Provides the capability to compile JasperReports design files. This plugin is based on a private fork of [gradle-jasperreports](https://github.com/gmazelier/gradle-jasperreports)
...
### Installation
    ...
    plugins {
        id("com.github.f-cramer.jasperreports") version "<version>"
    }
